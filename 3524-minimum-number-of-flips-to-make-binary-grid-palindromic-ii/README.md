<h2><a href="https://leetcode.com/problems/minimum-number-of-flips-to-make-binary-grid-palindromic-ii">Minimum Number of Flips to Make Binary Grid Palindromic II</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an <code>m x n</code> binary matrix <code>grid</code>.</p>
