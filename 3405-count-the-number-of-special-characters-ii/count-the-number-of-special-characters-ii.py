...
class Solution:
    def numberOfSpecialChars(self, word: str) -> int:
        ...
        first_large_letter_index = defaultdict(lambda: -1)
        ...
        for i, letter in enumerate(word):
            ...
            if letter.islower():
                ...
                if first_large_letter_index[letter.lower()] == -1:
                    first_large_letter_index[letter.lower()] = i
        ...
        for letter in last_small_letter_index:
            if letter in first_large_letter_index and last_small_letter_index[letter] < first_large_letter_index[letter]:
