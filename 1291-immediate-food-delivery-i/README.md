<h2><a href="https://leetcode.com/problems/immediate-food-delivery-i">Immediate Food Delivery I</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>Table: <code>Delivery</code></p>
