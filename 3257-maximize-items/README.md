<h2><a href="https://leetcode.com/problems/maximize-items">Maximize Items</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>Table: <font face="monospace"><code>Inventory</code></font></p>
