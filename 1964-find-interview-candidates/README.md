<h2><a href="https://leetcode.com/problems/find-interview-candidates">Find Interview Candidates</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Table: <code>Contests</code></p>
