<h2><a href="https://leetcode.com/problems/two-sum-iii-data-structure-design">Two Sum III - Data structure design</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>Design a data structure that accepts a stream of integers and checks if it has a pair of integers that sum up to a particular value.</p>
